...
public class MainActivity extends Activity {
	...
	*/
    ...
    public ImageView dropbardrawer = (ImageView) findViewById(R.id.bar_drawer);
    public RelativeLayout rootlayoutdrawer = (RelativeLayout) findViewById(R.id.drawer_rootlayout);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		*/
        ...
        dropbardrawer.setOnTouchListener(new View.OnTouchListener() {
            @Override
	...
	public boolean onTouchEvent(MotionEvent event) {
        ...
        if (checkbarpressed==true) {
            ...
            params.height=rootlayout.getHeight()-y;
            params.topMargin=y;
